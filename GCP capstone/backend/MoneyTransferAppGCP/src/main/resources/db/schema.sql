-- ============================================================
-- Money Transfer System — MySQL Schema
-- ============================================================
...
CREATE TABLE transaction_logs (
    ...
    CONSTRAINT fk_tx_from_account      FOREIGN KEY (from_account) REFERENCES accounts(id),
    CONSTRAINT fk_tx_to_account        FOREIGN KEY (to_account) REFERENCES accounts(id)
);
